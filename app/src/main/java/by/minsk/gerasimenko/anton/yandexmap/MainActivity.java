package by.minsk.gerasimenko.anton.yandexmap;
...
import by.minsk.gerasimenko.anton.yandexmap.views.Login;
...
// Перемещаем карту на заданные координаты
        mMapController.setPositionAnimationTo(new GeoPoint(53.48986, 26.73866));
